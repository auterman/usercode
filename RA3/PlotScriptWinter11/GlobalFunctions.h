...
double Mchi1(const SusyScan* p) {return p->Mchi1;}
...
double ExpRP1(const SusyScan* p) {return p->ExpRP1;}
double ExpRM2(const SusyScan* p) {return p->ExpRM2;}
double ExpRP2(const SusyScan* p) {return p->ExpRP2;}
double ObsR(const SusyScan* p) {return p->ObsR;}



double ExpExclusion(const SusyScan* p) {return (ExpR(p) > 1.0 ? 1 : 0.01); }
double ExpExclusionM1(const SusyScan* p) {return (ExpRM1(p) > 1.0 ? 1 : 0.01); }
...
//	if(Mgluino(p)==400 && Msquark(p)==400){
//			std::cout<<Mgluino(p)<<" - "<<Msquark(p)<<"XSEC "<<p->NLOXsection<<" - ObsR:"<<p->ObsR<<std::endl;
//		}
...
double ExpRasymP1(const SusyScan* p) {return p->ExpRasymP1;}
double ObsRasym(const SusyScan* p) {return p->ObsRasym;}

double ExpExclusionAsym(const SusyScan* p) {return (ExpRasym(p) > 1.0 ? 1 : 0.01); }
double ExpExclusionAsymM1(const SusyScan* p) {return (ExpRasymM1(p) > 1.0 ? 1 : 0.01); }
double ExpExclusionAsymP1(const SusyScan* p) {return (ExpRasymP1(p) > 1.0 ? 1 : 0.01); }
double ObsExclusionAsym(const SusyScan* p) {return (ObsRasym(p) > 1.0 ? 1 : 0.01); }
