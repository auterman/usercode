...
int main(int argc, char* argv[]) {
   ...
   {
   Points.Reset();
   ReadSignalAcceptance("","inputWinter11/signalAcceptanceWinoV20az_Dec19.dat", "inputWinter11/data_V20az_Dec19.txt");
   ...
   //2-jets
   Points.Reset();
   ReadSignalAcceptance("2j","inputWinter11/signalAcceptanceWinoV20az_Dec19.dat", "inputWinter11/data_V20az_Dec19.txt");
   AddXsec("inputWinter11/wino375NLOxsec2_Dec1.dat");
   AddPDFxsec("inputWinter11/PDFcross.txt", 375);
   AddPDFAcceptance("inputWinter11/PDFacceptance.txt", 375);
   {points MergedPoints;
   ...
   //3-jets
   Points.Reset();
   ReadSignalAcceptance("","inputWinter11/signalAcceptanceBino_Bec1_V17hg.dat", "inputWinter11/data_V20az_Dec19.txt");
   ...
   //2-jets
   Points.Reset();
   ReadSignalAcceptance("2j","inputWinter11/signalAcceptanceBino_Bec1_V17hg.dat", "inputWinter11/data_V20az_Dec19.txt");
   AddXsec("inputWinter11/bino375NLOxsec2_Dec1.dat");
   AddPDFxsec("inputWinter11/PDFcross.txt", 375);
   AddPDFAcceptance("inputWinter11/PDFacceptance.txt", 375);
   {points MergedPoints;
   ...
   //3-jets
   Points.Reset();
   ReadSignalAcceptance("","inputWinter11/signalAcceptanceBinoNeutrV20az_Dec19.dat", "inputWinter11/data_V20az_Dec19.txt");
   ...
   //2-jets
   Points.Reset();
   ReadSignalAcceptance("2j","inputWinter11/signalAcceptanceBinoNeutrV20az_Dec19.dat", "inputWinter11/data_V20az_Dec19.txt");
   AddXsec("inputWinter11/binochixsec2_Dec1.dat");
   AddPDFxsec("inputWinter11/PDFcrossBino_NeutrScan.txt");
   AddPDFAcceptance("inputWinter11/PDFacceptanceBino_NeutrScan.txt");
   {points MergedPoints;
