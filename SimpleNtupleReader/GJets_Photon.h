...
// Tue Jul 22 11:07:38 2014 by ROOT version 5.34/18
// from TChain photonTree/
//////////////////////////////////////////////////////////

#ifndef GJets_Photon_h
#define GJets_Photon_h
...
class GJets_Photon : public TSelector {
public :
   TTree          *fChain;   //!pointer to the analyzed TTree or TChain
const static Int_t kMaxphotons = 20;
const static Int_t kMaxjets = 130;
const static Int_t kMaxelectrons = 20;
const static Int_t kMaxmuons = 30;
const static Int_t kMaxgenPhotons = 130;
const static Int_t kMaxgenElectrons = 30;
int ThePhoton;
float ThePhotonPt;
float ThePhotonPhi;
float ThePhotonEta;
   ...
   GJets_Photon(TTree * /*tree*/ =0) : fChain(0) { }
   virtual ~GJets_Photon() { }
   ...
   //ClassDef(GJets_Photon,0);
};

#endif

#ifdef GJets_Photon_cxx
void GJets_Photon::Init(TTree *tree)
{
