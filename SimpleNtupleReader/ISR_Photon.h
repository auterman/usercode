...
// Tue Jul 22 11:25:17 2014 by ROOT version 5.34/18
...
class ISR_Photon : public TSelector {
public :
...
float ThePhotonEta;
   ...
   ISR_Photon(TTree * /*tree*/ =0) : fChain(0) { }
   virtual ~ISR_Photon() { }
   ...
   //ClassDef(ISR_Photon,0);
};

#endif

#ifdef ISR_Photon_cxx
void ISR_Photon::Init(TTree *tree)
{
