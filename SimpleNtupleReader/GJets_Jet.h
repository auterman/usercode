...
// Tue Jul 22 11:07:53 2014 by ROOT version 5.34/18
...
const static Int_t kMaxjets = 120;
const static Int_t kMaxelectrons = 20;
const static Int_t kMaxmuons = 20;
const static Int_t kMaxgenPhotons = 150;
...
float ThePhotonEta;
   ...
   GJets_Jet(TTree * /*tree*/ =0) : fChain(0) { }
   virtual ~GJets_Jet() { }
...
#ifdef GJets_Jet_cxx
void GJets_Jet::Init(TTree *tree)
{
