...
double transverse_met(GJets_Photon*t) {
    return CalcTransMet(t->met,t->metPhi-kPI,t->photons_phi[0]);
}
...
double parallel_met(GJets_Photon*t) {
    return CalcParalMet(t->met,t->metPhi-kPI,t->photons_phi[0]);
}
...
{
    TVector2 r1;
    r1.SetMagPhi(pt1, phi1);
    TVector2 r2;
    r2.SetMagPhi(pt2, phi2);
    TVector2 r3;
    r3.SetMagPhi(pt3, phi3);
    r1 += r2;
    r1 += r3;
    return r1.Mod();
}
