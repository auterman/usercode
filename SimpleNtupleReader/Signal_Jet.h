...
const static Int_t kMaxgenElectrons = 25;
   ...
   Signal_Jet(TTree * /*tree*/ =0) : fChain(0) { }
   virtual ~Signal_Jet() { }
   ...
   //ClassDef(Signal_Jet,0);
};

#endif

#ifdef Signal_Jet_cxx
void Signal_Jet::Init(TTree *tree)
{
