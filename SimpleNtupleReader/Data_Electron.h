...
// Tue Jul 22 11:09:45 2014 by ROOT version 5.34/18
// from TChain photonElectronTree/
//////////////////////////////////////////////////////////

#ifndef Data_Electron_h
#define Data_Electron_h
...
class Data_Electron : public TSelector {
public :
int ThePhoton;
float ThePhotonPt;
float ThePhotonPhi;
...
const static Int_t kMaxjets = 100;
const static Int_t kMaxelectrons = 20;
const static Int_t kMaxmuons = 20;
...
const static Int_t kMaxgenElectrons = 10;
   ...
   Data_Electron(TTree * /*tree*/ =0) : fChain(0) { }
   virtual ~Data_Electron() { }
   ...
   //ClassDef(Data_Electron,0);
};

#endif

#ifdef Data_Electron_cxx
void Data_Electron::Init(TTree *tree)
{
