...
public:
    ...
    Event(Event*e) {
        vars_=e->vars_; //VariableIndex_=e->GetVariableIndex();
    ...
    void   Set(const std::string& variable, double v) {
        vars_[VariableIndex_[variable] ].SetValue( v );
    }
    ...
    std::map<const std::string, unsigned> GetVariableIndex() const {
        return VariableIndex_;
    }
    std::map<const std::string, unsigned>::const_iterator GetVariableBegin() const {
        return VariableIndex_.begin();
    }
    std::map<const std::string, unsigned>::const_iterator GetVariableEnd() const {
        return VariableIndex_.end();
    }
