...
void SetDefault(style * s=0)
{
    ...
    s->lumiTemperaturePlot = new TLatex(0.48, 0.912, "L_{int} = 4.04 fb^{  -1}    #geq1 #gamma, #geq2 jets");
...
style* SqGlBino_Style() { /// Sq-Gl Bino /// ---------------------------------------------------------------------
    ...
    s->lumi      = new TLatex(0.57, 0.902, "L_{int} = 4.04 fb^{  -1}   #geq1#gamma, #geq2 jets");
...
style* SqGlWino_Style() { /// Sq-Gl Wino /// ---------------------------------------------------------------------
    ...
    s->lumi      = new TLatex(0.57, 0.902, "L_{int} = 4.04 fb^{  -1}   #geq1#gamma, #geq2 jets");
    s->cms       = new TLatex(0.21, 0.902, "#bf{CMS}    #sqrt{s} = 8 TeV");
    s->cmsprelim = new TLatex(0.2,  0.902, "#bf{CMS preliminary}    #sqrt{s} = 8 TeV");
...
style* GlBino_Style() {
    ...
    s->lumi      = new TLatex(0.58, 0.902, "L_{int} = 4.04 fb^{  -1}   #geq1#gamma, #geq2 jets");
    s->cms       = new TLatex(0.21, 0.902, "#bf{CMS}    #sqrt{s} = 8 TeV");
    s->cmsprelim = new TLatex(0.21, 0.902, "#bf{CMS preliminary}    #sqrt{s} = 8 TeV");
