...
int plot(int argc, char** argv) {
    ...
    if (1) { // 4.04 fb-1
        DoPlotsFor("squark","gluino","GMSB_8TeV_Bino2j","2012-06-21-17-05-GMSB_sqgBino375_8TeV_2j/filelist.txt",SqGlBino_Style(),4);
        DoPlotsFor("squark","gluino","GMSB_8TeV_Wino2j","2012-06-21-17-06-GMSB_sqgWino375_8TeV_2j/filelist.txt",SqGlWino_Style(),4);
    }
