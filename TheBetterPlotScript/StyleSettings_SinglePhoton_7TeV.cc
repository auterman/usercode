...
void SetDefault(style * s=0)
{
    ...
    s->lumiTemperaturePlot = new TLatex(0.48, 0.912, "L_{int} = 4.62 fb^{  -1}    #geq1 #gamma, #geq2 jets");
    ...
    s->cmsTemperaturePlot = new TLatex(0.18, 0.912, "#bf{CMS}   #sqrt{s} = 7 TeV");
    ...
    s->cmsprelimTemperaturePlot = new TLatex(0.18, 0.912, "#bf{CMS preliminary}   #sqrt{s} = 7 TeV");
...
style* SqGlWino_Style() { /// Sq-Gl Wino /// ---------------------------------------------------------------------
    style * s = new style();
    s->leg       = new TLegend(0.47,0.66,0.80,0.85,"#splitline{Wino-like #tilde{#chi}^{0} NLSP}{m_{#tilde{#chi}^{0}} = 375 GeV}");
    s->lumi      = new TLatex(0.57, 0.902, "L_{int} = 4.62 fb^{  -1}   #geq1#gamma, #geq2 jets");
    s->cms       = new TLatex(0.21, 0.902, "#bf{CMS}    #sqrt{s} = 7 TeV");
    s->cmsprelim = new TLatex(0.2,  0.902, "#bf{CMS preliminary}    #sqrt{s} = 7 TeV");
...
style* SMST1gg_Style() {
    style * s = new style();
    s->leg       = new TLegend(0.22,0.68,0.55,0.88,"SMS bino-like #tilde{#chi}^{0}");
    s->lumi      = new TLatex(0.57, 0.902, "L_{int} = 4.62 fb^{  -1}   #geq1#gamma, #geq2 jets");
    s->cms       = new TLatex(0.21, 0.902, "#bf{CMS}   #sqrt{s} = 7 TeV");
    s->cmsprelim = new TLatex(0.21, 0.902, "#bf{CMS preliminary}    #sqrt{s} = 7 TeV");
    s->excluded=0;
...
style* SMST1lg_Style() {
    style * s = new style();
    s->leg       = new TLegend(0.22,0.68,0.55,0.88,"SMS wino-like #tilde{#chi}^{0}");
    s->lumi      = new TLatex(0.57, 0.902, "L_{int} = 4.62 fb^{  -1}   #geq1#gamma, #geq2 jets");
    s->cms       = new TLatex(0.21, 0.902, "#bf{CMS}   #sqrt{s} = 7 TeV");
    s->cmsprelim = new TLatex(0.21, 0.902, "#bf{CMS preliminary}    #sqrt{s} = 7 TeV");
    s->excluded=0;
