...
//  if (1){
    ...
    //DoPlotsFor("chi1",  "cha1",  "GMSB_7TeV_WinoBino2j","2012-09-20-20-57-GMSB_WinoBino_7TeV_2j/filelist.txt",WinoBino_Style(),0);
    //DoPlotsFor("squark","gluino","GMSB_7TeV_Wino2j",    "2012-06-23-13-27-GMSB_sqgWino_7TeV_2j/filelist.txt", SqGlWino_Style(),2);
    //DoPlotsFor("squark","gluino","GMSB_7TeV_Bino2j",    "2012-06-18-16-57-GMSB_sqgBino_7TeV_2j/filelist.txt", SqGlBino_Style(),4);
    //DoPlotsFor("cha1",  "gluino","GMSB_7TeV_Wino2j_autoBin",    "2012-06-19-13-41-GMSB_gWino_7TeV_2j/filelist.txt",   GlWino_Style(),1);
    //DoPlotsFor("cha1",  "gluino","GMSB_7TeV_Wino2j",    "2012-06-19-13-41-GMSB_gWino_7TeV_2j/filelist.txt",   GlWino_Style(),1, new TH2F("gl_Wino",";M_{wino} [GeV];M_{gluino} [GeV]",50,105,955,55,300,1200), new TH2F("cfjkgl_Wino","",18, 80, 980, 14, 290, 990));
    //DoPlotsFor("chi1",  "gluino","GMSB_7TeV_Bino2j",    "2012-06-22-09-36-GMSB_gBino_7TeV_2j/filelist.txt",   GlBino_Style(),4);
    DoPlotsFor("gluino","neutralino",  "T1gg2j",  	"2012-05-22-21-38-GMSB_T1gg2j/filelist.txt",	      SMST1gg_Style(),1);
    DoPlotsFor("gluino","neutralino",  "T1lg2j",  	"2012-05-22-21-45-GMSB_T1lg2j/filelist.txt",	      SMST1lg_Style(),1);
...
//  MultipleChannels("cha1","gluino","GMSB_SingleChannels_Wino2j",   "2012-07-25-19-56-GMSB_gWino_7TeV_SingleChannels2j");
