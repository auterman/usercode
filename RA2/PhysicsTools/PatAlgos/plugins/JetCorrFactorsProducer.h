//
// $Id: JetCorrFactorsProducer.h,v 1.11 2010/03/20 22:47:33 hegner Exp $
//
...
/**
  ...
  \version  $Id: JetCorrFactorsProducer.h,v 1.11 2010/03/20 22:47:33 hegner Exp $
*/
...
namespace pat {
  ...
  class JetCorrFactorsProducer : public edm::EDProducer {
    ...
    private:
      ...
      JetCorrectionUncertainty * jtuncrt_;
