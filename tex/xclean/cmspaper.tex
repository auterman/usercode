...
%    \includegraphics[scale=0.8]{figures/ElecJet/LM4_sharedE_iso_A.eps}
    ...
    \caption{Distance \(\Delta R\) (upper row) and shared Energy, normalised to jet energy, (left plot lower row) with the closest Jet for isolated Electrons before (left) and after (right) the cross cleaning. Lower right: $\Delta$R to closest electron for jets modified in the cleaning.}
...
\begin{center}
    ...
    of non-isolated electron and closest jet before the cross-cleaning.}
...
cleaning. As the energy correction of the jet is a vectorial correction, it may
