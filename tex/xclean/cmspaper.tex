...
The inputs to the cleaning algorithm are collections of physics objects which pass the
...
The number of conflicts depends on the sample and on the acceptance cuts on the
...
after the cross cleaning. As the energy correction of the jet is a vectorial
...
support. Special thanks go to Rob Bainbridge for fixing and improving the code,
Georgia Karapostoli for her testing and contributions to the Electron-Jet
cleaning, and all other users of this package who gave helpful feedback.
