...
after the cleaning. The preset isolation cut is on $0.1$\ GeV. 
...
The dataset used here was \textcolor{red}{Blabla}.

\begin{figure}[hb]
\begin{center}
    \includegraphics[scale=0.8]{figures/MuonJet/Zmumu_Eff_pt_Muon.eps}
    \includegraphics[scale=0.8]{figures/MuonJet/Zmumu_Eff_eta_Muons.eps}\\
    \includegraphics[scale=0.8]{figures/MuonJet/Zmumu_Cont_pt_Muons.eps}
    \includegraphics[scale=0.8]{figures/MuonJet/Zmumu_Cont_eta_Muons.eps}
