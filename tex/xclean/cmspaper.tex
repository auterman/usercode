...
R$ matching. {\color{red}(Check configuration)}.
...
double & trkIsoWeight  & Weight of tracker isolation in CombRelIso variable & 1.0 \\\hline
\end{tabular}
\end{center}
...
double & IsoValueCut       & Cut on isolation & 0.3                 \\\hline
string & IsolationKey      &
\begin{minipage}[t]{8cm} Key to choose isolation method as defined in
    DataFormats/PatCandidates/interface/Isolation.h\\
