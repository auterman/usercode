#!/bin/zsh
  ...
  do
    ...
    cat $i
    file="${i##*/}"
    echo "copying $LIMITDIR/$file to job$SGE_TASK_ID/results/$file"
    ...
    echo "calling ./rooStat job$SGE_TASK_ID/results/$file"  
    ./rooStat         job$SGE_TASK_ID/results/$file
    ./rooStat.LO.obs  job$SGE_TASK_ID/results/$file
    ./rooStat.LO.exp  job$SGE_TASK_ID/results/$file
    ./rooStat.NLO.obs job$SGE_TASK_ID/results/$file
    ./rooStat.NLO.exp job$SGE_TASK_ID/results/$file
  done
  du -h --max-depth=1
  date
