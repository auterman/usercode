...
TGraph* Obs7TeV5fbM0M12()
{
   ...
   graph->SetLineColor(8);
   graph->SetLineWidth(2);
   graph->SetPoint(0,2966.667,296.0286);
   graph->SetPoint(1,2960,295.0885);
   graph->SetPoint(2,2940,294.0582);
   graph->SetPoint(3,2920,292.9555);
   graph->SetPoint(4,2913.333,291.746);
   graph->SetPoint(5,2900,290.3835);
   graph->SetPoint(6,2880,289.0927);
   graph->SetPoint(7,2860,287.8713);
   graph->SetPoint(8,2853.333,286.7057);
   graph->SetPoint(9,2840,285.6244);
   graph->SetPoint(10,2820,284.5947);
   graph->SetPoint(11,2800,283.5629);
   graph->SetPoint(12,2780,282.7371);
   graph->SetPoint(13,2766.667,282.0907);
   graph->SetPoint(14,2760,281.5808);
   graph->SetPoint(15,2749.963,281.2031);
   graph->SetPoint(16,2735.187,280.892);
   graph->SetPoint(17,2720.468,280.5185);
   graph->SetPoint(18,2705.916,280.3188);
   graph->SetPoint(19,2691.582,280.2434);
   graph->SetPoint(20,2677.272,280.2766);
   graph->SetPoint(21,2663.029,280.4385);
   graph->SetPoint(22,2648.877,280.6105);
   graph->SetPoint(23,2634.78,280.791);
   graph->SetPoint(24,2620.61,281.0239);
   graph->SetPoint(25,2606.391,281.3433);
   graph->SetPoint(26,2592.129,281.6436);
   graph->SetPoint(27,2577.776,281.9333);
   graph->SetPoint(28,2563.337,282.3347);
   graph->SetPoint(29,2548.797,282.7404);
   graph->SetPoint(30,2533.999,283.1847);
   graph->SetPoint(31,2519.021,283.7287);
   graph->SetPoint(32,2503.83,284.3747);
   graph->SetPoint(33,2488.518,285.0658);
   graph->SetPoint(34,2472.955,285.7711);
   graph->SetPoint(35,2457.217,286.7144);
   graph->SetPoint(36,2441.388,287.6598);
   graph->SetPoint(37,2425.36,288.6266);
   graph->SetPoint(38,2409.255,289.6595);
   graph->SetPoint(39,2393.085,290.7443);
   graph->SetPoint(40,2376.775,291.9095);
   graph->SetPoint(41,2360.402,293.1724);
   graph->SetPoint(42,2343.981,294.3216);
   graph->SetPoint(43,2327.591,295.3566);
   graph->SetPoint(44,2311.304,296.2457);
   graph->SetPoint(45,2295.124,297.1694);
   graph->SetPoint(46,2279.019,298.1261);
   graph->SetPoint(47,2262.956,299.0952);
   graph->SetPoint(48,2246.926,299.8748);
   graph->SetPoint(49,2230.987,300.4766);
   graph->SetPoint(50,2215.197,300.8826);
   graph->SetPoint(51,2199.546,301.2884);
   graph->SetPoint(52,2184.086,301.6638);
   graph->SetPoint(53,2168.716,301.9704);
   graph->SetPoint(54,2153.423,302.2162);
   graph->SetPoint(55,2138.196,302.4107);
   graph->SetPoint(56,2123.018,302.565);
   graph->SetPoint(57,2107.874,302.6907);
   graph->SetPoint(58,2092.755,302.8264);
   graph->SetPoint(59,2077.676,303.0238);
   graph->SetPoint(60,2062.752,303.2507);
   graph->SetPoint(61,2047.927,303.4442);
   graph->SetPoint(62,2033.188,303.8084);
   graph->SetPoint(63,2018.496,304.3611);
   graph->SetPoint(64,2003.811,305.0956);
   graph->SetPoint(65,1989.122,305.818);
   graph->SetPoint(66,1974.372,306.5989);
   graph->SetPoint(67,1959.644,307.4892);
   graph->SetPoint(68,1944.911,308.4789);
   graph->SetPoint(69,1930.143,309.5551);
   graph->SetPoint(70,1915.314,310.7022);
   graph->SetPoint(71,1900.394,311.9028);
   graph->SetPoint(72,1885.356,313.1381);
   graph->SetPoint(73,1870.138,314.5474);
   graph->SetPoint(74,1854.85,316.1196);
   graph->SetPoint(75,1839.388,317.6052);
   graph->SetPoint(76,1823.693,319.0681);
   graph->SetPoint(77,1807.85,320.5575);
   graph->SetPoint(78,1791.833,322.0665);
   graph->SetPoint(79,1775.533,323.6337);
   graph->SetPoint(80,1759.003,325.2872);
   graph->SetPoint(81,1742.24,326.8272);
   graph->SetPoint(82,1725.202,328.321);
   graph->SetPoint(83,1708.049,329.9337);
   graph->SetPoint(84,1690.85,331.6319);
   graph->SetPoint(85,1673.521,333.3703);
   graph->SetPoint(86,1656.074,335.1466);
   graph->SetPoint(87,1638.519,336.9571);
   graph->SetPoint(88,1620.882,338.8234);
   graph->SetPoint(89,1603.215,340.7796);
   graph->SetPoint(90,1585.467,342.8765);
   graph->SetPoint(91,1567.713,345.1402);
   graph->SetPoint(92,1549.967,347.3676);
   graph->SetPoint(93,1532.253,349.7373);
   graph->SetPoint(94,1514.746,352.27);
   graph->SetPoint(95,1497.355,354.9166);
   graph->SetPoint(96,1480.074,357.6699);
   graph->SetPoint(97,1462.893,360.5201);
   graph->SetPoint(98,1445.801,363.4541);
   graph->SetPoint(99,1428.781,366.4552);
   graph->SetPoint(100,1411.874,369.6183);
   graph->SetPoint(101,1395.129,372.895);
   graph->SetPoint(102,1378.442,376.2236);
   graph->SetPoint(103,1361.751,379.4966);
   graph->SetPoint(104,1345.001,382.759);
   graph->SetPoint(105,1328.336,386.1543);
   graph->SetPoint(106,1311.801,389.6292);
   graph->SetPoint(107,1295.289,393.1214);
   graph->SetPoint(108,1278.784,396.6142);
   graph->SetPoint(109,1262.268,400.0923);
   graph->SetPoint(110,1245.729,403.5418);
   graph->SetPoint(111,1229.209,407.0641);
   graph->SetPoint(112,1212.77,410.6211);
   graph->SetPoint(113,1196.274,414.0759);
   graph->SetPoint(114,1179.683,417.489);
   graph->SetPoint(115,1163.1,420.9044);
   graph->SetPoint(116,1146.566,424.4229);
   graph->SetPoint(117,1130.142,428.0043);
   graph->SetPoint(118,1113.688,431.5091);
   graph->SetPoint(119,1097.162,434.9942);
   graph->SetPoint(120,1080.721,438.6152);
   graph->SetPoint(121,1064.419,442.3293);
   graph->SetPoint(122,1048.161,446.083);
   graph->SetPoint(123,1031.891,449.7779);
   graph->SetPoint(124,1015.566,453.4685);
   graph->SetPoint(125,999.3389,457.3073);
   graph->SetPoint(126,983.262,461.2484);
   graph->SetPoint(127,967.2345,465.2342);
   graph->SetPoint(128,951.2422,469.2503);
   graph->SetPoint(129,935.327,473.3954);
   graph->SetPoint(130,919.5011,477.5384);
   graph->SetPoint(131,903.6326,481.6896);
   graph->SetPoint(132,887.8163,485.8861);
   graph->SetPoint(133,872.0314,490.1069);
   graph->SetPoint(134,856.2558,494.3293);
   graph->SetPoint(135,840.4798,498.5569);
   graph->SetPoint(136,824.7198,502.8057);
   graph->SetPoint(137,808.9785,507.0655);
   graph->SetPoint(138,793.2327,511.313);
   graph->SetPoint(139,777.4594,515.5255);
   graph->SetPoint(140,761.6937,519.7958);
   graph->SetPoint(141,745.9434,523.9891);
   graph->SetPoint(142,730.0747,528.1147);
   graph->SetPoint(143,714.183,532.2113);
   graph->SetPoint(144,698.2505,536.2614);
   graph->SetPoint(145,682.2605,540.2486);
   graph->SetPoint(146,666.1531,544.0695);
   graph->SetPoint(147,649.9375,547.8893);
   graph->SetPoint(148,633.7797,551.7184);
   graph->SetPoint(149,617.5787,555.5003);
   graph->SetPoint(150,601.2786,559.1353);
   graph->SetPoint(151,584.8353,562.6785);
   graph->SetPoint(152,568.3457,566.1697);
   graph->SetPoint(153,551.7931,569.5924);
   graph->SetPoint(154,535.1614,572.9309);
   graph->SetPoint(155,518.3914,576.0822);
   graph->SetPoint(156,501.4354,579.0977);
   graph->SetPoint(157,484.5019,581.9566);
   graph->SetPoint(158,467.5463,584.5663);
   graph->SetPoint(159,450.4714,586.9013);
   graph->SetPoint(160,433.237,589.0035);
   graph->SetPoint(161,415.9458,590.9024);
   graph->SetPoint(162,398.5878,592.5741);
   graph->SetPoint(163,380,594);
   graph->SetPoint(164,360,595.1672);
   graph->SetPoint(165,340,595.9818);
   graph->SetPoint(166,320,596.5101);
   graph->SetPoint(167,300,596.8104);
   graph->SetPoint(168,280,596.8912);
   graph->SetPoint(169,260,596.7684);
   graph->SetPoint(170,240,596.3758);
   graph->SetPoint(171,233.3333,595.8064);
   graph->SetPoint(172,220,595.1408);
   graph->SetPoint(173,200,594.4052);
   graph->SetPoint(174,180,593.6265);
   graph->SetPoint(175,160,592.8311);
   graph->SetPoint(176,140,592.0435);
   graph->SetPoint(177,120,591.1967);
   return graph;
}
TGraph* Obs7TeV5fbSqGl()
{
   ...
   graph->SetLineColor(8);
   graph->SetLineWidth(2);
   graph->SetPoint(0,1130.639,1007.784);
   graph->SetPoint(1,1146.681,1021.117);
   graph->SetPoint(2,1162.681,1034.433);
   graph->SetPoint(3,1177.695,1047.653);
   graph->SetPoint(4,1191.299,1060.909);
   graph->SetPoint(5,1204.229,1073.996);
   graph->SetPoint(6,1215.949,1086.5);
   graph->SetPoint(7,1226.55,1098.316);
   graph->SetPoint(8,1236.373,1109.205);
   graph->SetPoint(9,1245.636,1119.234);
   graph->SetPoint(10,1255.018,1128.289);
   graph->SetPoint(11,1264.977,1136.423);
   graph->SetPoint(12,1275.376,1144.011);
   graph->SetPoint(13,1287.201,1151.392);
   graph->SetPoint(14,1300.437,1158.662);
   graph->SetPoint(15,1314.109,1166.547);
   graph->SetPoint(16,1327.721,1175.241);
   graph->SetPoint(17,1340.418,1184.795);
   graph->SetPoint(18,1351.696,1195.287);
   graph->SetPoint(19,1360.567,1206.532);
   graph->SetPoint(20,1365.655,1218.183);
   graph->SetPoint(21,1366.106,1230.117);
   graph->SetPoint(22,1361.665,1241.761);
   graph->SetPoint(23,1352.244,1252.854);
   graph->SetPoint(24,1337.957,1263.12);
   graph->SetPoint(25,1319.199,1272.755);
   graph->SetPoint(26,1297.298,1281.826);
   graph->SetPoint(27,1273.228,1290.654);
   graph->SetPoint(28,1247.492,1299.435);
   graph->SetPoint(29,1221.21,1308.593);
   graph->SetPoint(30,1195.981,1318.303);
   graph->SetPoint(31,1172.425,1328.74);
   graph->SetPoint(32,1150.668,1339.92);
   graph->SetPoint(33,1130.881,1352.007);
   graph->SetPoint(34,1113.184,1364.84);
   graph->SetPoint(35,1097.155,1378.442);
   graph->SetPoint(36,1083.057,1392.811);
   graph->SetPoint(37,1070.366,1407.622);
   graph->SetPoint(38,1058.336,1422.688);
   graph->SetPoint(39,1047.106,1438.186);
   graph->SetPoint(40,1036.581,1453.741);
   graph->SetPoint(41,1025.792,1469.253);
   graph->SetPoint(42,1015.022,1484.758);
   graph->SetPoint(43,1004.355,1500.372);
   graph->SetPoint(44,993.8628,1515.955);
   graph->SetPoint(45,983.149,1531.489);
   graph->SetPoint(46,972.4255,1547.021);
   graph->SetPoint(47,961.7069,1562.557);
   graph->SetPoint(48,951.1064,1578.186);
   graph->SetPoint(49,940.8957,1594.003);
   graph->SetPoint(50,931.2336,1610.062);
   graph->SetPoint(51,922.1949,1626.386);
   graph->SetPoint(52,914.0074,1643.148);
   graph->SetPoint(53,906.829,1660.23);
   graph->SetPoint(54,900.2459,1677.59);
   graph->SetPoint(55,894.6405,1695.457);
   graph->SetPoint(56,890.2598,1713.736);
   graph->SetPoint(57,886.6626,1732.355);
   graph->SetPoint(58,883.9078,1751.322);
   graph->SetPoint(59,881.94,1770.601);
   graph->SetPoint(60,880.6292,1790.131);
   graph->SetPoint(61,880,1810);
   graph->SetPoint(62,879.6854,1829.738);
   graph->SetPoint(63,878.5581,1849.192);
   graph->SetPoint(64,876.8271,1868.372);
   graph->SetPoint(65,874.3474,1887.224);
   graph->SetPoint(66,871.0338,1905.725);
   graph->SetPoint(67,866.9031,1923.9);
   graph->SetPoint(68,861.785,1941.564);
   graph->SetPoint(69,855.4471,1958.821);
   graph->SetPoint(70,848.4437,1975.83);
   graph->SetPoint(71,832,1992.288);
   graph->SetPoint(72,832,2008.052);
   graph->SetPoint(73,832,2022.911);
   graph->SetPoint(74,832,2036.608);
   graph->SetPoint(75,816,2048.876);
   graph->SetPoint(76,784,2059.492);
   graph->SetPoint(77,784,2068.471);
   return graph;
}
