/* ----------------------------------------------------------------------------------------------
  internal class for table class
  column stores the elements of the table in their original type (template T), i.e. not as string.
  Christian Autermann, Uni Hamburg, 01.07.2011
  ----------------------------------------------------------------------------------------------*/
